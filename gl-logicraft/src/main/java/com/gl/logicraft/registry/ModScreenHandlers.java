...
public class ModScreenHandlers {
         ...
         * Uses ExtendedScreenHandlerType so the server can pass circuit data to the
         * client.
         * NBT_COMPOUND codec is used to transmit the pos + circuit layout.
         */
        public static final ScreenHandlerType<LogicScreenHandler> LOGIC_SCREEN = Registry.register(
